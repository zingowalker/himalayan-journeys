...
const ItineraryDetails = ({ itinerary, slug: itinerarySlug }) => {
  return (
    <div className="px-2 md:px-10 bg-stone-800 dark:bg-accent text-light dark:text-dark py-2 flex items-center justify-between flex-wrap text-lg sm:text-xl font-medium mx-5 md:mx-10 ">
