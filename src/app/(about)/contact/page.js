...
export const metadata = {
  title: "Contact Us",
  description: `Contact us for Trekking, Motorbike, Wildlife, Packaged tours and Multi-day itinerary. Email ${siteMetadata.email}`,
};
...
export default function Contact() {
  return (
    <section className="w-full h-auto md:h-[75vh] border-b-2 border-solid border-dark dark:border-light flex  flex-col md:flex-row items-center justify-center text-dark dark:text-light">
      ...
      <div className="w-full mt-8 md:w-3/5 flex flex-col items-start justify-center px-5 xs:px-10 md:px-16 pb-8">
